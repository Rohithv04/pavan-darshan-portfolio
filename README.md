# Pavan Darshan Doddala — Executive Finance Portfolio
...
- **Applied Research**: 5 core research papers with micro-statistics and an expandable drawer to reveal additional manuscripts.
- **Direct Engagement**: Integrated contact form with client validation, mailto fallback, and recruiter-focused quick actions.
- **Performance & SEO**: Semantic HTML5, zero external build bloat, full Open Graph metadata, and JSON-LD Person schema.
...
```
├── index.html            # Complete semantic 1-page structure
├── css/
